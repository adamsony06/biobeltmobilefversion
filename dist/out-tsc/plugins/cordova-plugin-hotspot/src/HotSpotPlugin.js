...
export class Hotspot {
    ...
    getWriteSettings(successCB, errorCB) {
        cordova.exec(function (val) {
            if (val === 1)
                ...
                successCB(false);
        }, errorCB, 'HotSpotPlugin', 'getWriteSettings', []);
    }
    /**
     * get the current write settings of the app
     ...
     */
    requestWriteSettings(requestWriteSettingsCallback, errorCB) {
        cordova.exec(successCB, errorCB, 'HotSpotPlugin', 'requestWriteSettings', []);
    }
    /**
 ...
 *      An error callback
 */
pingHost(ip, string, successCB, Function, errorCB, Function);
void {
 ...
 *      An error callback
 */
getMacAddressOfHost(ip, string, successCB, Function, errorCB, Function);
void {
    cordova, : .exec(successCB, function (err) {
        errorCB(err);
 ...
 *      An error callback
 */
isDnsLive(ip, string, successCB, Function, errorCB, Function);
void {
    cordova, : .exec(function (code) {
        if (code === 1) {
            successCB(true);
 ...
 *      An error callback
 */
isPortLive(ip, string, successCB, Function, errorCB, Function);
void {
    cordova, : .exec(function (code) {
        if (code === 1) {
            successCB(true);
 ...
 *      An error callback
 */
isRooted(successCB, Function, errorCB, Function);
void {
    cordova, : .exec(function (code) {
        if (code === 1) {
            successCB(true);
