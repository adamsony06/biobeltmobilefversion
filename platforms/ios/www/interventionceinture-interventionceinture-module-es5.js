...
var InterventionceinturePage = /** @class */ (function () {
    function InterventionceinturePage(upcv3service, storage, router, global, geolocation) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.storage.get('token').then(function (val) {
                            ...
                            _this.upcv3service.getUPC3(_this.token).subscribe(function (res) {
                                _this.data2 = res.result;
                                _this.geolocation.getCurrentPosition().then(function (res) {
                                    var lat = res.coords.latitude;
                                    var long = res.coords.longitude;
                                    //alert(JSON.stringify(this.data2))
                                    _this.data2.forEach(function (element) {
                                        if (_this.getDistanceFromLatLonInKm(lat, long, element.lat, element.lng) < 30) {
                                    ...
                                    console.log(JSON.stringify(_this.nearUPC));
    ...
    InterventionceinturePage.prototype.selectionCeinture = function () {
    };
    ...
    InterventionceinturePage.prototype.goTo = function () {
