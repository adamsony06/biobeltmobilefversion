...
var VerifpiegesindividuelsPageRoutingModule = /** @class */ (function () {
    function VerifpiegesindividuelsPageRoutingModule() {
    }
    ...
    return VerifpiegesindividuelsPageRoutingModule;
}());
...
var VerifpiegesindividuelsPageModule = /** @class */ (function () {
    function VerifpiegesindividuelsPageModule() {
    }
    ...
    return VerifpiegesindividuelsPageModule;
}());
...
var VerifpiegesindividuelsPage = /** @class */ (function () {
    function VerifpiegesindividuelsPage(router, storage, global) {
        this.router = router;
    ...
    VerifpiegesindividuelsPage.prototype.ngOnInit = function () { };
    VerifpiegesindividuelsPage.prototype.ionViewWillEnter = function () {
        var _this = this;
    ...
    VerifpiegesindividuelsPage.prototype.goToNextPage = function () {
        var _this = this;
        this.storage.get("nexturl").then(function (res) {
            _this.router.navigate([res]);
        });
    };
    VerifpiegesindividuelsPage.ctorParameters = function () { return [
    ...
    return VerifpiegesindividuelsPage;
}());
...
//# sourceMappingURL=verifpiegesindividuels-verifpiegesindividuels-module-es5.js.map